...
script_path=args[4]
source(paste0(script_path,"/", "st_spotter_QC_FUNCTIONS_hex.R"))
...
# "Kctd12", "Fabp7", "Mbp","Nrgn",
# interesting.genes.plot(all_barcodes, spots, genes=c("Snap25", "Penk", "Ppp3ca", "Kctd12", "Fabp7", "Mbp"))
#interesting.genes.plot(all_barcodes, spots, genes=c("Cux2", "Dcn", "Fa2h", "Foxp2", "Gad2", "Nxph4"))
interesting.genes.plot(all_barcodes, spots, genes=c("CD52", "LTB", "HLA-DRB1", "CD4", "MMP3", "MMP1"))
